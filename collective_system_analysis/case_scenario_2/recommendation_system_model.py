...
from collective_system_analysis.case_scenario_2.hotel_agent import DataSelectionLogic
    ...
    def __init__(self, width, height, n_hotels, n_customers, load_existing_data=False):
        ...
        for i in range(self.num_hotels):
            class MyModule(nn.Module):
                ...
                def intermediate_mapping(self, user_id):
                    '''
                    ...
                    '''
                    return torch.tensor(user_id_mapping[user_id], dtype=torch.int64)

                def __init__(self, n_features):
                    super().__init__()
                    self.user_embedding = nn.Embedding(480189, 50)
                    self.item_embedding = nn.Embedding(17770, 50)
            ...
            a = HotelAgent(i, self, agent_online_regression_model, agent_data, testing_data,
                           10, 2, 1000, 200,
                           100, 100000, 100, 0,
                           True, False, DataSelectionLogic.ORDERING_LOSS, False)
